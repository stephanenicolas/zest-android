...
import com.example.roboguice_demo.lib.integrationtesting.roboguice.RoboActivityUnitTestCase;
 ...
 * @author SNI
 */
public class EasyMockRoboActivityUnitTestCase<T extends Activity> extends RoboActivityUnitTestCase<T> {

	private EasyMockTestModule easyMocktestModule;
	private MockInjector mockInjector;

	public EasyMockRoboActivityUnitTestCase(Class<T> activityClass) {
		super(activityClass);
	}
