...
import com.example.roboguice_demo.lib.integrationtesting.roboguice.RoboSingleLaunchActivityTestCase;
 ...
 * @author SNI
 */
public class EasyMockRoboSingleLauncheActivityTestCase<T extends Activity> extends RoboSingleLaunchActivityTestCase<T> {

	private EasyMockTestModule easyMocktestModule;
	private MockInjector mockInjector;

	public EasyMockRoboSingleLauncheActivityTestCase(String packageName, Class<T> activityClass) {
